...
use App\Response\HtmlResponseStrategy;
use App\Response\JsonResponseStrategy;
...
return [
    ...
    ResponseStrategyInterface::class => factory(
        function (
            HtmlResponseStrategy $html,
            JsonResponseStrategy $json
            ...
            return $strategies[$_ENV['RESPONSE_FORMAT']];
        }
    ),
